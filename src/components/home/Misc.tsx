    ...
    return (
        <View style={styles.container}>
            ...
            <View style={commonStyles.flexRowBetween}>
                <CustomText fontFamily='Okra-Bold' style={styles.text} fontSize={22}>#1 World Best File Sharing App</CustomText>
                <Image source={require('../../assets/icons/share_logo.jpg')} style={styles.image} />
            </View>

            <CustomText fontFamily='Okra-Bold' style={styles.text2}>Made with ❤️ ~ Anurag Sharma</CustomText>
        </View>
    )
}
