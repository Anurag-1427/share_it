import { Modal, View, TouchableOpacity, ActivityIndicator, Image } from 'react-native';
...
const QRGenerateModal: FC<ModalProps> = ({ visible, onClose }) => {
    ...
    const [qrValue, setQrValue] = useState<string>('Anurag');
        ...
        <Modal
            ...
            <View style={modalStyles.modalContainer}>
                ...
                <View style={modalStyles.info}>
                    ...
                    <CustomText style={modalStyles.infoText2}>Ask the sender to scan this QR code to connect and transfer files.</CustomText>
                </View>
