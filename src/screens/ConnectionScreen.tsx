import { View, SafeAreaView, TouchableOpacity, FlatList, ActivityIndicator, Platform } from 'react-native'
            ...
            <View style={connectionStyles.fileItem}>
                <View style={connectionStyles.fileInfoContainer}>
                    ...
                    <View style={connectionStyles?.fileDetails}>
                        ...
                        <CustomText>{item?.mimeType} • {formatFileSize(item?.size)}</CustomText>
                    </View>
                </View>
                {
                    item?.available ? (
                    ...
                    <View style={connectionStyles.fileContainer}>
                        <View style={connectionStyles.sendReceiveContainer}>
                            <View style={connectionStyles.sendReceiveButtonContainer}>
                                <TouchableOpacity onPress={() => handleTabChange('SENT')} style={[connectionStyles.sendReceiveButton, activeTab === 'SENT' ? connectionStyles.activeButton : connectionStyles.inactiveButton]}>
                                ...
                                <TouchableOpacity onPress={() => handleTabChange('RECEIVED')} style={[connectionStyles.sendReceiveButton, activeTab === 'RECEIVED' ? connectionStyles.activeButton : connectionStyles.inactiveButton]}>
                            ...
                            (activeTab === 'SENT' ? sentFiles?.length : receivedFiles?.length) > 0 ? (
                                ...
                                <View style={connectionStyles.noDataContainer}>
                                    <CustomText numberOfLines={1} fontFamily='Okra-Medium' fontSize={11}>
                                        {
                                            activeTab === 'SENT' ? "No files sent yet" : "No files recived yet"
                                        }
                                    </CustomText>
                                </View>
                            )
